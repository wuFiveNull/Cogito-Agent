...
**v0.8.0 (Console MVP Phases 1–8)** — Web Console with Dashboard, Chat, Memory Review, Approval Queue, Trace & Audit Viewer, Autonomy Console, Config Viewer, Doctor page, and security regression hardening.
