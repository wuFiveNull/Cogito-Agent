...
def test_record_feedback(feedback_store: FeedbackStore):
    fid = feedback_store.record_feedback(
        decision_id="d-fb-1", event_id="e-fb-1",
        value="useful", workspace_id="ws-1",
    )
...
def test_get_feedback_for_decision(feedback_store: FeedbackStore):
    fid = feedback_store.record_feedback(
        decision_id="d-fb-2", event_id="e-fb-2",
        value="not_useful", workspace_id="ws-1",
    )
...
def test_get_recent_feedback(feedback_store: FeedbackStore):
    feedback_store.record_feedback(
        decision_id="d1", event_id="e1",
        value="too_many", workspace_id="ws-1",
    )
    feedback_store.record_feedback(
        decision_id="d2", event_id="e2",
        value="wrong_time", workspace_id="ws-1",
    )
...
def test_record_feedback_with_comment(feedback_store: FeedbackStore):
    fid = feedback_store.record_feedback(
        decision_id="d-fb-c", event_id="e-fb-c",
        value="useful", comment="great suggestion",
        workspace_id="ws-1",
    )
